...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="assets/HOME2/picture/logo.png"/>
        ...
        <div class="main">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="//q.qlogo.cn/headimg_dl?bs=qq&dst_uin=272341207&src_uin=pay.abcwl.cn&fid=666&spec=640">
                                </div>
                                <div class="vira-card-content">
                                    <h3>零度（272341207）</h3>
                                    <p>
                        ...
                        <div class="col-sm-4">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="//q.qlogo.cn/headimg_dl?bs=qq&dst_uin=1796791999&src_uin=pay.abcwl.cn&fid=666&spec=640">
                                </div>
                                <div class="vira-card-content">
                                    <h3>ABC网络（1796791999）</h3>
                                    <p>
                        ...
                        <div class="col-sm-4">
                            <div class="vira-card">
                                <div class="vira-card-header">
                                    <img class="img-responsive" src="/picture/intlpay.png">
                                </div>
                                <div class="vira-card-content">
                                    <h3>虚位以待（联系272341207）</h3>
                                    <p>
            ...
            <footer class="footer">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <p> 本站最终解释权归 <a href="//pay.abcwl.cn/" target="_blank" title="零度云支付">零度云支付</a> && <a href="//www.abcwl.cn/" title="ABC网络" target="_blank">ABC网络</a>所有</p>
                        </div>
                    </div>
                </div>
            </footer>
